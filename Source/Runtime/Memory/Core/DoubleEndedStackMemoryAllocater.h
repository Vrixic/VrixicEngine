...
{
protected:
	uint128 MemoryUsedFromTop;

public:
	DoubleEndedStackAllocater(char* inMemoryHandle, uint128 inSizeInBytes)
		: MemoryAllocater(inMemoryHandle, inSizeInBytes), MemoryUsedFromTop(0) { }
...
public:
	...
	*/
	...
	inline virtual uint128 GetMemoryUsed() override
	{
