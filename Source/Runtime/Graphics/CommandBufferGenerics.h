...
*/
struct VRIXIC_API FCommandBufferLevelFlags
{
public:
    enum
    {
...
*/
struct VRIXIC_API FCommandBufferConfig
{
public:
...
public:
    FCommandBufferConfig()
        : Flags(0), NumBuffersToAllocate(0), CommandQueue(nullptr) { }

    FCommandBufferConfig(const FCommandBufferConfig&) = default;
    FCommandBufferConfig& operator = (const FCommandBufferConfig&) = default;
};